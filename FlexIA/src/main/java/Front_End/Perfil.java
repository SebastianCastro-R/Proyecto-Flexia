...
public class Perfil extends javax.swing.JFrame {
     ...
     */
    // En el constructor, después de initComponents() y antes de initHeader():
    public Perfil() {
        ...
        // Asegurar que el header esté en la capa superior
        layeredPane.add(header, JLayeredPane.POPUP_LAYER);

        // Crear el menú (pero NO agregarlo al content pane aún)
        ...
        // AGREGAR EL MENÚ A LA MISMA CAPA QUE EL HEADER (POPUP_LAYER)
        // para que estén en el mismo nivel y el menú pueda estar encima
        layeredPane.add(menuPanel, JLayeredPane.POPUP_LAYER);

        // IMPORTANTE: Asegurarnos que el menú esté en el índice más alto dentro de
        // POPUP_LAYER
        // Esto hará que el menú esté encima del header cuando se despliegue
        layeredPane.setPosition(menuPanel, 0); // 0 = índice más alto en su capa
    ...
    private void initComponents() {
        ...
        roundedPanel2Layout.setHorizontalGroup(
                roundedPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                roundedPanel2Layout.createSequentialGroup()
        ...
        roundedPanel2Layout.setVerticalGroup(
                roundedPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(roundedPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(PlanLabel)
                                .addGap(40, 40, 40)
                                .addComponent(ButtonPremium, javax.swing.GroupLayout.PREFERRED_SIZE, 49,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(21, 21, 21)));

        roundedPanel1.add(roundedPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 60, 260, 250));

        jPanel1.add(roundedPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 700, 900));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Background_1.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1440, 1024));
         ...
         * 
         * Menu.setIcon(new
         * javax.swing.ImageIcon(getClass().getResource("/icons/menu.png"))); // NOI18N
         ...
         * }
         * });
         * jPanel2.add(Menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 5,
         * -1, 30));
         * 
         * Exit.setIcon(new
         ...
         * }
         * });
         * jPanel2.add(Exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1410, 0,
         * 30, 40));
         * 
         * Titulo1.setFont(new java.awt.Font("Epunda Slab ExtraBold", 0, 24)); // NOI18N
         * Titulo1.setForeground(new java.awt.Color(255, 255, 255));
         * Titulo1.setText("PERFIL");
         * jPanel2.add(Titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0,
         * -1, 40));
         * 
    ...
    // En Perfil.java, agrega este método y llámalo en el constructor después de
    // initComponents()
    ...
    private void initHeader() {
        ...
        header.setOpaque(true); // Asegurar que sea opaco

        // ===== BOTÓN MENÚ =====
        menuLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/menu.png")));
        ...
        titlelbl.setFont(new java.awt.Font("Epunda Slab ExtraBold", Font.PLAIN, 28));
        titlelbl.setForeground(Color.WHITE);
        // Centrar el título
        int titleWidth = 200;
        int titleX = 50;
        titlelbl.setBounds(titleX, 5, titleWidth, 30);
        header.add(titlelbl);

        // ===== BOTON MINIMIZAR =====
        minimizebtn.setBackground(new Color(30, 56, 136));
        minimizebtn.setBounds(getWidth() - 120, 0, 60, 40);
        minimizebtn.setOpaque(true);

        minimizetxt.setText("-");
        minimizetxt.setFont(new java.awt.Font("Arial", Font.BOLD, 24));
        ...
        Closetxt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                System.exit(0); // Cambié de dispose() a System.exit(0) para consistencia
            }
        ...
        // Agregar el header directamente al layered pane en lugar del content pane
        layeredPane = getLayeredPane();
    }
        ...
        if (menuVisible) {
            ...
            Timer slideOut = new Timer(2, e -> {
                if (menuX > -menuWidth) {
                    ...
                    menuVisible = false;
                    // Cuando el menú está oculto, asegurar que el header esté sobre él
                    layeredPane.setComponentZOrder(header, 0);
                    layeredPane.setComponentZOrder(menuPanel, 1);
                }
            });
            slideOut.start();
        } else {
            // Mostrar menú
            // Antes de mostrar el menú, asegurar que esté sobre el header
            layeredPane.setComponentZOrder(menuPanel, 0);
            layeredPane.setComponentZOrder(header, 1);
    ...
    private ImageIcon crearImagenCircularDeIcono(ImageIcon originalIcon, int width, int height) {
        ...
        java.awt.Image imagenOriginal = originalIcon.getImage().getScaledInstance(size, size,
        ...
        try {
            ...
            if (fotoPerfilTemporal != null) {
                ...
                if (usuarioActual != null) {
                    boolean fotoActualizada = dao.actualizarFotoPerfil(usuarioActual.getIdUsuario(),
                            fotoPerfilTemporal);
                    if (fotoActualizada) {
    ...
    private void configurarFotoPerfilClickListener() {
        ...
        Timer timer = new Timer(100, e -> {
            FotoPerfil.setCursor(modoEdicion ? new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR)
